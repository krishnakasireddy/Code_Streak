<h2><a href="https://practice.geeksforgeeks.org/problems/for-loop-primechecl/1?page=8&difficulty[]=0&status[]=unsolved&sortBy=submissions">For Loop- primeCheck</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><em><span style="font-size: 18px;">What do you do when you need to execute certain statements more than once? You put them in a loop. Loops are very powerful. Majority of coding questions need loops to work. You can't even input testcases without loops!</span></em></p>
