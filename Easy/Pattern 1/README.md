<h2><a href="https://practice.geeksforgeeks.org/problems/square-pattern/1?page=11&difficulty[]=0&status[]=unsolved&sortBy=submissions">Pattern 1</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Geek is very fond of patterns. Once, his teacher gave him a&nbsp;square pattern to solve. He gave Geek&nbsp;an integer n and asked him to build a pattern.</span></p>
